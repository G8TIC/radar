...
OBJ=radar.o banner.o avr.o beast.o beast_tcp.o beast_serial.o dupe.o hex.o chain.o mstime.o ustime.o sha256.o sha512.o hmac-sha256.o authtag.o stats.o telemetry.o arch.o xtimer.o qerror.o
