...
echo ""
echo ""
echo "Step 1: Determine protocol support"
echo "----------------------------------"
echo ""
echo "The protocol used by readsb/dump1090 on your system may be BEAST (binary) or AVR (ASCII)"
echo "depending on how it was installed... we'll try and figure this out automatically..."
echo ""
